	...
	if(!isset($role))
	   ...
	   {				 		    	
		 ...
		 $acl->addResource(new Zend_Acl_Resource('default:employeedocs'));
                    $acl->allow('admin', 'default:employeedocs', array('index','view','save','delete','edit','editpay','update','uploadsave','uploaddelete','downloadfiles'));
